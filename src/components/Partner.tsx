    ...
    <section id="partner-section" className="sec-wrap reveal" ref={ref}>
      <div className="sec-head">
        <div className="sec-head-left">
          ...
          <div className="sys-title">PARTNER<br />WITH US</div>
        </div>
      ...
      <div className="partner-grid">
        <div className="partner-info">
          ...
          <div className="data-row"><div className="dot"></div>ACCEPTING PARTNERS</div>
          <div className="partner-info-title">COLLABORATE<br />WITH US</div>
          <p>We are looking forward to collaborations with companies, individuals, communities, and more who can support HackVSIT 7.0. Fill the form and we'll get back to you.</p>
        ...
        <div className="partner-form-wrap">
          <div className="data-row" style={{ marginBottom: '20px' }}><div className="dot"></div>SUBMIT INQUIRY</div>
          <form className="partner-form" onSubmit={e => e.preventDefault()}>
            ...
            <textarea className="pf-field pf-area" placeholder="Tell us about yourself and how you'd like to partner..."></textarea>
            <button type="submit" className="btn btn-y" style={{ alignSelf: 'flex-start' }}>Submit Inquiry →</button>
          </form>
        </div>
      </div>
    </section>
