...
export default function Hero2() {
    return (
        <div className=" flex items-center justify-center overflow-hidden text-(--white) bg-[#0E0E0E]">
            {/* Background Layers */}
            ...
            {/* Top Vignette */}
            <div className="pointer-events-none absolute inset-x-0 top-0 h-32 bg-linear-to-b to-transparent" />

            <div className=" justify-center pt-20 z-10 mx-auto flex w-full max-w-400  flex-col items-center px-4 ">
                {/* Hero Content */}
                <div className="flex w-full  flex-col items-center text-center mt-8 md:mt-12">
                    {/* Badge */}
                    <div className="inline-flex items-center gap-2 rounded-full border border-(--yellow) bg-(--ydim) px-4 py-2 shadow-[0_0_30px_rgba(245,197,24,0.08)]">
                        <span className="h-1.5 w-1.5 rounded-full bg-(--yellow)" />
                        <span className="text-[10px] font-semibold uppercase tracking-[0.24em] text-(--yellow)">
                            Coming Soon
                        </span>
                    </div>

                    {/* Heading */}
                    <h1 className="font-bold text-[clamp(56px,10vw,120px)] leading-[0.9] tracking-[-0.04em] mt-2">
                        <span className="block">
                            HACKVSIT{" "}
                            <span className="inline-block rounded-xl bg-(--yellow) px-4 py-1 text-(--black)">7.0</span>
                        </span>
                    </h1>

                    {/* Description */}
                    <p className="max-w-205 text-sm leading-normal text-(--dim) sm:text-base mt-2">
            ...
            <span className="flex h-8 w-8 items-center justify-center rounded-full bg-black/15 text-base">
              →
                ...
                <div className="mt-8 flex w-full justify-center sm:mt-16">
                    <div className="w-full max-w-300 overflow-hidden  border border-(--border) bg-(--panel) shadow-[0_20px_80px_rgba(0,0,0,0.45)]">
                        <div className="relative">
                            ...
                            <img
                                src={heroPhoto}
                                alt="HackVSIT Team"
                                className="block h-65 w-full object-cover object-center sm:h-105 md:h-135 lg:h-162.5"
                            />
                        </div>
                    </div>
                </div>
