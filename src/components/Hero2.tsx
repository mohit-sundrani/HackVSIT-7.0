      ...
      <div className=" justify-center pt-20 z-10 mx-auto flex w-full max-w-[1600px]  flex-col items-center px-4 ">
        ...
        <div className="flex w-full  flex-col items-center text-center ">
          ...
          <h1 className="font-[var(--font)] text-[clamp(56px,10vw,120px)] font-bold leading-[0.9] tracking-[-0.04em] mt-2">
            ...
            <span className="my-6 inline-flex items-center gap-4">
              <span>7.0</span>
              <span className="inline-flex h-[0.9em] w-[0.9em] items-center justify-center rounded-full bg-[var(--yellow)]">
                <svg
                  viewBox="0 0 24 24"
                  className="h-[0.42em] w-[0.42em] fill-[var(--black)]"
          ...
          <p className="max-w-[820px] text-sm leading-[1.5] text-[var(--dim)] sm:text-base gap-">
            NORTH INDIA&apos;S BIGGEST HACKATHON. 24 HOURS. DREAM UP &amp;
            BUILD THE TECHNOLOGY OF TOMORROW TO SOLVE THE PROBLEMS WE FACE
            TODAY.
          </p>
